...
class App extends React.Component{
  ...
  approveSession = () => {
    ...
    const { peerId } = this.props.wallet.walletConnect
    console.log(this.props.wallet.walletConnect)
    this.props.walletConnectApproveSessionRequest(
        peerId,
        {
            accounts: address,
            chainId
  ...
  onBarCodeScanned = (dataObject) =>{
    ...
    this.props.walletConnectOnSessionRequest(dataObject.data)
  }
  ...
  render(){
    ...
    const { 
        ...
        connected,
        messages
    } = this.props.wallet.walletConnect;
...
export default connect(
  mapStateToProps,
  {walletConnectOnSessionRequest,walletConnectApproveSessionRequest}
)(App);